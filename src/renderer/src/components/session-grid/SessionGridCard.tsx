...
export function SessionGridCard({
  ...
  const terminalFocused = useSessionGridTerminalFocus(viewportRef)
  ...
  return (
    <div
      ...
      data-terminal-focused={terminalFocused ? 'true' : undefined}
      ...
      className={cn(
        ...
        isActive ? 'border-ring/80' : 'border-border hover:border-border/80',
        terminalFocused && 'ring-2 ring-ring/40 shadow-xs',
