...
export function SessionGridLaunchPopoverContent({
  ...
  const groups = useMemo(() => {
    ...
    // oxlint-disable-next-line react-hooks/exhaustive-deps -- buildLaunchGroups translates the heading using the active language.
  }, [direct, activeFilter, worktreeCatalog, gridWorktreeIds, defaultWorktreeId, i18n.language])
